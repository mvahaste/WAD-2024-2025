  ...
  <div id="signup-container">
    <div id="signup-card">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <input type="password" id="password" class="input-field" placeholder="Password" v-model="password"
          required /><br />

        <label for="password2" class="input-field-label">Retype password:</label><br />
        <input type="password" id="password2" class="input-field" placeholder="Password" v-model="password2"
          required /><br />
